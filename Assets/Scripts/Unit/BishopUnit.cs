...
public class BishopUnit : UnitBehaviour
{
    ...
    {
        movementSet = UnitMovement.GetBishopMovementTiles(movementParams.currentPosition, movementParams.settings, movementParams.gridCells);
